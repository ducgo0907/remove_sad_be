...
const socketIo = new Server(server, {
	cors: {
		origin: 'http://localhost:3000, https://ducgo0907.github.io', // Replace with the actual origin of your frontend
		methods: 'GET,HEAD,PUT,PATCH,POST,DELETE',
		credentials: true, // Enable credentials (important for cookies and authentication)
	},
});
app.use(cors({
	origin: 'http://localhost:3000, https://ducgo0907.github.io', // Replace with the origin of your frontend
	methods: 'GET,HEAD,PUT,PATCH,POST,DELETE',
